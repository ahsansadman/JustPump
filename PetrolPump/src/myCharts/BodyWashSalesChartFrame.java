 ...
 * @author Sadman's Den
 */
public class BodyWashSalesChartFrame extends javax.swing.JFrame {

    /**
     * Creates new form BodyWashSalesChartFrame
     */
    public BodyWashSalesChartFrame() {
        initComponents();
    ...
    void generatePieChart(){
        float iSale = 0, oSale = 0, fSale = 0, sSale = 0; 
        ...
        for(String ss : list){
            String[] str = ss.split(",");
            if(str[1].equals("FullWash"))fSale+= Float.parseFloat(str[2]);
            if(str[1].equals("InnerWash")) iSale+= Float.parseFloat(str[2]);
            if(str[1].equals("OuterWash")) oSale+= Float.parseFloat(str[2]);
            if(str[1].equals("SpecialWash")) sSale+= Float.parseFloat(str[2]);
        }
    
        DefaultPieDataset piedataset = new DefaultPieDataset();  
        piedataset.setValue("FullWash", fSale) ;  
        piedataset.setValue("InnerWash", iSale); 
        piedataset.setValue("OuterWash", oSale);  
        piedataset.setValue("SpecialWash", sSale);    
        ...
        File imageFile = new File("CarWashSalesPieChart.jpg");
        int width = 270;
        int height = 250;
        try {
    ...
    void generateBarChart(){
        ...
        //for(int j=0;j<c;j++){
        bardataset.setValue(fSale,Float.toString(fSale) ,"Full" );
        bardataset.setValue(iSale,Float.toString(iSale) ,"Inner" );
        bardataset.setValue(oSale,Float.toString(oSale) ,"Outer" );
        bardataset.setValue(sSale,Float.toString(sSale) ,"Special" );
        ...
        File imageFile = new File("CarWashSalesBarChart.jpg");
        int width = 270;
        int height = 250;
        try {
     ...
     void generateLineChart(){
        ...
        for(String ss : list){
         ...
         System.out.println(fSale);
         System.out.println(iSale);
         System.out.println(oSale);
         System.out.println(sSale);
    
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();  
        dataset.setValue(fSale, Float.toString(fSale) ,"Full" );
        dataset.setValue(iSale, Float.toString(iSale) ,"Inner" );
        dataset.setValue(oSale, Float.toString(oSale) ,"Outer" );
        dataset.setValue(sSale, Float.toString(sSale) ,"Special" );

        JFreeChart lineChart = ChartFactory.createLineChart(  
            "Line Chart",  // Title  
            "Wash Type",             // X-axis Label  
            "Sale(tk)",             //y 
            dataset,             
            PlotOrientation.VERTICAL,        
            false,                 
        ...
        lineChartPanel.add(cPanel,BorderLayout.CENTER);
         ...
         File imageFile = new File("CarWashSalesLineChart.jpg");
        int width = 270;
        int height = 250;
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BodyWashSalesChartFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BodyWashSalesChartFrame().setVisible(true);
            }
        });
    }
